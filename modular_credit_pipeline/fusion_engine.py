...
MAESTRO (Multi-Agent Explainable Adaptive STructured-Textual Risk Oracle) fusion engine.
...
class MAESTROGlobalFusion:
    ...
    def fuse_expert_assessments(self, expert_assessments: Dict[str, Dict[str, Any]], 
        ...
        """
        logger.info("🔄 Starting MAESTRO fusion process...")
        ...
        logger.info(f"✅ MAESTRO fusion complete. Final score: {final_fused_score:.1f}")
    ...
    def _generate_fusion_summary(self, final_score: float, market_regime: str, 
        ...
        summary = f"MAESTRO Fusion Result: {risk_level} risk (score: {final_score:.1f}/100) "
    ...
    def get_fusion_explanation(self, fusion_result: Dict[str, Any]) -> str:
        ...
        explanation.append("MAESTRO FUSION EXPLANATION")
...
def fuse_scores(structured_result: Dict[str, Any], unstructured_result: Dict[str, Any], 
               market_data: Dict[str, Any] = None) -> Dict[str, Any]:
    """
    Main function to fuse structured and unstructured scores using MAESTRO.
    ...
    """
    try:
        logger.info("🔄 Starting score fusion with MAESTRO...")
        
        # Initialize MAESTRO fusion engine
        maestro = MAESTROGlobalFusion()
        ...
        # Perform fusion
        fusion_result = maestro.fuse_expert_assessments(expert_assessments, market_data)
        
        # Add explanation
        fusion_result['detailed_explanation'] = maestro.get_fusion_explanation(fusion_result)
